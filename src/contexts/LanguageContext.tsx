...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.mm':' and Myanmar',
    'hero.ygn': 'Get Yangon',
    'hero.titleHighlight': '(Almost Half Price) (Only for 7 weeks) within 2026 Jan 15',
  ...
  my: {
    ...
    'hero.ygn': 'ရန်ကုန်   ',
    'hero.titleHighlight': '( တစ်ဝက် လျော့ဈေး ) ဖြင့် ရယူလိုက်ပါ (နှစ်ပတ် အတွင်းသာ 2026 Jan 15 အထိသာ)',
